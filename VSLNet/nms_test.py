...
with open('checkpoints/nlq_official_clip_10s/vslnet_nlq_official_clip_10s_video_swin_512_bert/model/vslnet_29455_train_result.json') as file_id:
    predictions = json.load(file_id)["results"]

# with open(f'outputs/vslnet_predictions_clip4clip_nms_fps_10_clip_similarity.json') as file_id:
#     predictions = json.load(file_id)["results"]
