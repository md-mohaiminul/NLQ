...
data_json = f'/playpen-storage/mmiemon/ego4d/Ego4d/annotations/v1/annotations/nlq_test_unannotated.json'
...
for video_datum in data:
    ...
    for clip_datum in video_datum["clips"]:
        ...
        save_path = f'/playpen-storage/mmiemon/ego4d/data/v1/clip/{clip_uid}.pt'
