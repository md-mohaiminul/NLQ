...
CUDA_VISIBLE_DEVICES=1 CUDA_LAUNCH_BLOCKING=1 python main.py \
    --exp clip_video_swin_128_256_nce_val \
...
#PRED_FILE="checkpoints/clip_video_swin_128_256_nce/model"
...
#    --model_prediction_json checkpoints/clip_video_swin_128_256_nce/model/vslnet_30096_test_result.json \
#    --thresholds 0.3 0.5 \
#    --topK 1 3 5
