...
from utils.data_util import pad_seq, pad_char_seq, pad_video_seq, visual_feature_sampling

class Dataset(torch.utils.data.Dataset):
    def __init__(self, dataset, video_features, max_pos_len, sampling_strategy='mean'):
...
def get_test_loader(dataset, video_features, configs):
    test_set = Dataset(dataset=dataset, video_features=video_features, max_pos_len = configs.max_pos_len, sampling_strategy='mean')
