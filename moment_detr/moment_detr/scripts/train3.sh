...
######## data paths
train_path=data/ego4d_clip_10s/train_500.json
eval_path=data/ego4d_clip_10s/val_500.json
eval_split_name=val
...
PYTHONPATH=$PYTHONPATH:. CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=4 python moment_detr/train.py \
--dset_name ${dset_name} \
--ctx_mode ${ctx_mode} \
