...
def dataloader_ego4d_train(args, tokenizer):
    ego4d_dataset = Ego4d_DataLoader(
        subset="train",
        data_path=args.data_path,
        features_path=args.features_path,
        max_words=args.max_words,
...
def dataloader_ego4d_test(args, tokenizer, subset="val"):
    ego4d_testset = Ego4d_DataLoader(
        subset=subset,
        data_path=args.data_path,
        features_path=args.features_path,
        max_words=args.max_words,
